...
<html>    
	...
	<h2 style="margin-left: 10px"> Paid Premiums </h2>
        <table style="background: black" width = "100%" class="table-container" cellspacing = "1" cellpadding = "1">    
	...
	?>  
		...
		<h2 style="margin-left: 10px"> Unpaid Premiums </h2>
        <table style="background: black" width = "100%" class="table-container" cellspacing = "1" cellpadding = "1">    
            <tr style="background: #ffffff36">    
                <td>Policy_Num</td>    
				<td>Premium</td>    
